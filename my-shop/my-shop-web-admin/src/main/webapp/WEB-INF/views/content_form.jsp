                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input id="categoryName" class="form-control required categoryId"
                                               placeholder="请选择父级类目" readonly="true"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                            <%--<form:textarea rows="5" path="content" class="form-control" placeholder="详情"/>--%>
